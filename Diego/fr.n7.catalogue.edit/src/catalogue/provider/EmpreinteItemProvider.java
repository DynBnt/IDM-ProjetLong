...
public class EmpreinteItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Empreinte_nom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Empreinte_nom_feature", "_UI_Empreinte_type"),
				 CataloguePackage.Literals.EMPREINTE__NOM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CataloguePackage.Literals.EMPREINTE__HAUTEUR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CataloguePackage.Literals.EMPREINTE__PORTS);
		}
	...
	public String getText(Object object) {
		String label = ((Empreinte)object).getNom();
		return label == null || label.length() == 0 ?
			getString("_UI_Empreinte_type") :
			getString("_UI_Empreinte_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.EMPREINTE__PORTS,
