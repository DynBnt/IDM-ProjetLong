...
public class NetlistAdapterFactory extends AdapterFactoryImpl {
	...
	protected NetlistSwitch<Adapter> modelSwitch =
		new NetlistSwitch<Adapter>() {
			...
			@Override
			public Adapter caseNetlistElement(NetlistElement object) {
				return createNetlistElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link netlist.NetlistElement <em>Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNetlistElementAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link netlist.InstancePort <em>Instance Port</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
