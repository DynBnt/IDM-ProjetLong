 ...
 * @generated
 */
public class InstanceComposantItemProvider extends NetlistElementItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstanceComposant_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstanceComposant_type_feature", "_UI_InstanceComposant_type"),
				 NetlistPackage.Literals.INSTANCE_COMPOSANT__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NetlistPackage.Literals.INSTANCE_COMPOSANT__PORTS);
		}
	...
	public String getText(Object object) {
		String label = ((InstanceComposant)object).getNom();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NetlistPackage.Literals.INSTANCE_COMPOSANT__PORTS,
				 NetlistFactory.eINSTANCE.createInstancePort()));
	}
