 ...
 * @generated
 */
public class CommentaireItemProvider extends NetlistElementItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSujetPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Sujet feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSujetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Commentaire_sujet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Commentaire_sujet_feature", "_UI_Commentaire_type"),
				 NetlistPackage.Literals.COMMENTAIRE__SUJET,
				 true,
				 false,
				 true,
				 null,
