...
public class PortImpl extends MinimalEObjectImpl.Container implements Port {
	...
	protected EClass eStaticClass() {
		return CataloguePackage.Literals.PORT;
	}
	...
	public void setX(double newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CataloguePackage.PORT__X, oldX, x));
	}
	...
	public void setY(double newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CataloguePackage.PORT__Y, oldY, y));
	}
